...
public enum ErrorType {
    ...
    NOT_USER(4800, "Bu işlemi yapabilmek için user olmalısınız.", HttpStatus.BAD_REQUEST),
    COULDNT_FOUND_AUTHID(4900, "Authid bulunamadı.", HttpStatus.BAD_REQUEST),
    COULDNT_SAVE(5000, "Kayıt yapılamadı, bir daha deneyin.", HttpStatus.BAD_REQUEST);
